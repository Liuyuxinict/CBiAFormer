...
@register_model
def volo_d3(pretrained=None, **kwargs):
    """
    ...
    if pretrained is not None:
        ...
        filtered_dict = {k: v for k, v in state.items() if k != "head.weight" and k != "head.bias"}
...
def volo_d5(pretrained=False, **kwargs):
    ...
    return model
'''
model = volo_d3(pretrained="E:/Pretrained_model/d3_224_85.4.pth.tar",
                num_classes = 101,
                drop_path_rate = 0.1)
